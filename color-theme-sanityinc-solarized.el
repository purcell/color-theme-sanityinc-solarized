    ...
    (let ((background (first backgrounds))
      ...
      (color-theme-install
       `(,(intern (concat "color-theme-sanityinc-solarized-" (symbol-name'light)))
         ...
         (gnus-summary-normal-unread ((:t (:foreground ,strong))))
         (gnus-summary-normal-read ((:t (:foreground ,normal))))
         (gnus-summary-low-unread ((:t (:foreground ,faintest))))
         (gnus-summary-low-read ((:t (:foreground ,faint))))
         (gnus-summary-high-unread ((:t (:foreground ,orange))))
         (gnus-summary-high-read ((:t (:foreground ,yellow))))
         (gnus-summary-high-ancient ((:t (:foreground ,yellow))))

         (gnus-group-mail-low ((t (:foreground ,faintest))))
         (gnus-group-mail-low-empty ((t (:foreground ,faintest))))
         (gnus-group-mail-1 ((t (:foreground nil :bold t :inherit outline-1))))
         (gnus-group-mail-2 ((t (:foreground nil :bold t :inherit outline-2))))
         (gnus-group-mail-3 ((t (:foreground nil :bold t :inherit outline-3))))
         (gnus-group-mail-4 ((t (:foreground nil :bold t :inherit outline-4))))
         (gnus-group-mail-5 ((t (:foreground nil :bold t :inherit outline-5))))
         (gnus-group-mail-6 ((t (:foreground nil :bold t :inherit outline-6))))
